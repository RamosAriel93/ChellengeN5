--> Proyecto Cypress para chellenge con Klimber


---> Requisitos

-----> Node.js v18.17.1 o superior
----->  VSCode (ultima version)

---> Dependencias

-----> Cypress: v13.6.0 o superior
-----> Mochawesome: v7.1.3 o superior
-----> Cypress Mochawesome Reporter: v3.7.0 o superior


## Instalación
1. Instalar dependencias y requisitos.
